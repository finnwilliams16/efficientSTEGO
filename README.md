...
Work completed for my dissertation titled "Self-supervised Semantic Segmentation"
...
How I fixed the issue where GPU isn't connected to internet:
Isolate the code and run it on the login node in python shell.
E.g. for eval_segmentation.py:
'''
import torch
from utils import *
